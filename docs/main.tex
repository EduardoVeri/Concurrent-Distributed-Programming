...
\begin{table}[ht]
  ...
  \begin{tabular}{||c c c c||}
    ...
    \hline
    MPI          & 1T/1P                & 23.32  $\pm$ 1.19 & 1.04    \\
    \hline
    MPI          & 1T/2P                & 25.05  $\pm$ 1.52 & 1.69    \\
    \hline
    MPI          & 1T/4P                & 124.10 $\pm$ 1.33 & 2.01    \\
    \hline
    MPI          & 1T/8P                & 23.32  $\pm$ 1.34 & 1.70    \\
    \hline
    MPI          & 1T/16P               & 1.31   $\pm$ 1.31 & 1.57    \\
    \hline
    MPI          & 1T/32P               & 124.10 $\pm$ 1.81 & 1.31    \\
    \hline
  \end{tabular}
\end{table}
